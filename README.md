# Generador de firmas Carrousel

Proyecto estático para crear firmas HTML reutilizables para Gmail con el diseño Carrousel.

## Archivos

- `index.html`: generador listo para publicar y compartir.
...
No requiere build ni dependencias. Es HTML estático.
